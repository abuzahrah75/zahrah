...
urlpatterns = [
    ...
    path('password-reset/done',
         auth_views.PasswordResetDoneView.as_view(
             template_name="pengguna/password_reset_done.html"), name='password_reset_done'),
    path('password-reset-confirm/<uidb64>/<token>/',
         auth_views.PasswordResetConfirmView.as_view(
             template_name="pengguna/password_reset_confirm.html"), name='password_reset_confirm'),
